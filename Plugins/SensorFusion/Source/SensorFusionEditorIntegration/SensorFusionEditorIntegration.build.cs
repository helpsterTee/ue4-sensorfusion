...
namespace UnrealBuildTool.Rules
{
    public class SensorFusionEditorIntegration : ModuleRules
    {
        ...
        public SensorFusionEditorIntegration(TargetInfo Target)
        {
            ...
            PrivateDependencyModuleNames.AddRange(new string[] { "UnrealEd", "SensorFusionCore", "InputCore", "SlateCore", "Slate", "PropertyEditor", "GraphEditor", "AppFramework", "EditorStyle" });
        }
    }
}